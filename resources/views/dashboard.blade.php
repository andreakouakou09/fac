            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h4 class="card-title">Listes des derniers messages</h4>
                        <div class="d-flex ">
                    ...
                    <div class="card-body px-0 pb-0">
                        <div class="table-responsive">
                            <table class='table mb-0' id="table1">
                                ...
                                <tbody>
                                    @if ($contacts>0)
                                        @foreach ($contactslistes as $contactsliste )
                                        <tr>
                                            <td>{{ $contactsliste->nomprenom }}</td>
                                            <td>{{ $contactsliste->email }}</td>
                                            <td>{{ $contactsliste->contact }}</td>
                                            <td>{{ $contactsliste->sujet }}</td>
                                            <td>{{ $contactsliste->message }}</td>
                                        </tr>
                                        @endforeach
                                    @else
                                        <td>Aucun message pour l'instant</td>
                                    @endif
