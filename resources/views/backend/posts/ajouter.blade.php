                ...
                <div class="col-12 col-md-12 order-md-2 order-first">
                    <nav aria-label="breadcrumb" class='breadcrumb-header'>
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Ajouter Post</li>
                        </ol>
                    </nav>
                </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form" action="{{ url('/ajouter_traitement_post') }}" method="POST">
                                @csrf
                                <div class="row">
                                    ...
                                    <div class="col-md-12 col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="description" id="" cols="30" rows="5" placeholder="Entrez ici le message ..."></textarea>
                                    ...
                                    <div class="col-12 d-flex justify-content-end">
                                        ...
                                        <a href="listeposts.html" class="btn btn-success mr-1 mb-1">Liste des Postes</a>
                                    </div>
                                </div>
                            </form>
                        </div>
